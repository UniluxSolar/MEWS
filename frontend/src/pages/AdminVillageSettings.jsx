        ...
        <div className="min-h-screen bg-[#f3f4f6] font-sans flex flex-col">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto p-4 md:p-8">
                    {/* Header */}
                    <div className="mb-6">
                        <h1 className="text-2xl font-bold text-gray-900">Village Settings</h1>
                        <p className="text-sm text-gray-500 mt-1">Manage configuration and preferences for your village.</p>
                    </div>
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 animate-fade-in-up">
                                    ...
                                    <div className="space-y-6 max-w-2xl">
                                        <div>
                                            ...
                                            <input type="text" defaultValue="Peddakaparthy" className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-bold hover:border-gray-300 focus:outline-none focus:border-blue-500" />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="email" defaultValue="admin.peddakaparthy@mews.org" className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 text-sm hover:border-gray-300 focus:outline-none focus:border-blue-500" />
                                        </div>
                                        <div className="pt-4">
