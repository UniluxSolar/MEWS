        ...
        const loadMemberData = async () => {
            if (location.state && location.state.newMember) {
                ...
                setSelectedMember({
                    ...
                    photo: newMember.photoUrl ? (newMember.photoUrl.startsWith('http') ? newMember.photoUrl : `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8080'}${newMember.photoUrl}`) : member2,
