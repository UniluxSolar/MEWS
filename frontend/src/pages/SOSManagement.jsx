            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto p-4 md:p-8 bg-[#f8fafc]">
                    <DashboardHeader
                        ...
                        subtitle="Live monitoring of emergency alerts | Auto-refresh every 5 seconds"
                    >
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2 text-sm font-bold text-red-600 animate-pulse bg-red-50 px-3 py-1.5 rounded-lg border border-red-100">
                                <div className="w-2 h-2 rounded-full bg-red-600"></div>
                                {sosAlerts.length} Live Alerts
                            </div>
                            <button className="bg-white bg-opacity-10 hover:bg-opacity-20 backdrop-blur-md text-white px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 shadow-sm transition border border-white/20">
