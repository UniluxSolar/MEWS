...
import {
    ...
    FaSignOutAlt, FaSearch, FaBell, FaChevronDown, FaChevronUp, FaDownload, FaPlus
} from 'react-icons/fa';
...
const MemberRegistration = () => {
    ...
    const handleFinalSubmit = async () => {
        ...
        try {
            ...
            const { data } = await axios.post('http://localhost:8080/api/members', dataPayload);
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <FormSelect
                                    ...
                                    disabled={false} // Enable typing if we switch to input later, but now select
                                />
