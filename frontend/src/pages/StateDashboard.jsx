            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto p-4 md:p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <StateStatCard title="Active Emergencies" value={stats.sos} icon={FaExclamationTriangle} color="bg-red-500" />
                            ...
                            <table className="w-full text-left">
                                <thead className="bg-gray-50 text-gray-500 text-xs uppercase font-bold">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4">SOS Alerts</th>
                                    ...
                                    {stats.districts.length > 0 ? (
                                        stats.districts.map((dist, idx) => (
                                            <tr key={idx} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 text-sm text-red-500 font-bold">{dist.sos}</td>
                                                <td className="px-6 py-4">
                                                    <span className={`px-2 py-1 rounded text-xs font-bold ${dist.sos > 0 ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
                                                        {dist.sos > 0 ? 'Alert' : 'Stable'}
                                                    </span>
                                                </td>
                                            </tr>
                                        ))
