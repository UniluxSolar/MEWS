...
import {
    ...
    FaCheckCircle, FaClock, FaChevronLeft, FaChevronRight, FaMapMarkerAlt
} from 'react-icons/fa';
...
const InstitutionManagement = () => {
    ...
    const applyFilters = () => {
        const newFilters = [];
        if (selectedType) newFilters.push(`Type: ${selectedType}`);
                                                ...
                                                return (
                                                    <tr key={inst._id} className="hover:bg-slate-50/80 transition-colors">
                                                        ...
                                                        <td className="px-6 py-4 text-center">
                                                            <Link to={`/admin/institutions/${inst._id}`} className="p-2 text-slate-400 hover:text-blue-600 transition inline-block">
                                                                <FaEye />
                                                            </Link>
                                                            <Link to={`/admin/institutions/edit/${inst._id}`} className="p-2 text-slate-400 hover:text-amber-500 transition inline-block">
                                                                <FaEdit />
                                                            </Link>
                                                        </td>
                                                    </tr>
