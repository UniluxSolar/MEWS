    ...
    const [notifications, setNotifications] = useState([
        {
            ...
            message: 'Your application for "Student Scholarship 2025" has been approved. The amount will be disbursed shortly.',
            time: '2 hours ago',
            isRead: false
        },
        {
            ...
            message: 'TechCorp is hiring for "Junior Developer" in Hyderabad. Apply now!',
            time: '5 hours ago',
            isRead: false
        },
        {
            ...
            message: 'Your uploaded bank passbook image was unclear. Please re-upload to complete verification.',
            time: '1 day ago',
            isRead: true
        },
        {
            ...
            message: 'Thank you for your donation of ₹5,000 for Child Education. 80G receipt is available.',
            time: '2 days ago',
            isRead: true
        }
    ]);
