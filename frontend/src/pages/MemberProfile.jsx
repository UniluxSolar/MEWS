...
const MemberProfile = () => {
    ...
    // Mock data for demo - ideally fetch based on ID
    // In a real app this would be a useEffect fetch
    const member = {
        name: "Ramesh Kumar",
        id: id || "MEW2024001",
        photo: member1,
        ...
        job: "Farmer",
        address: "1-123, Main Road, Peddakaparthy",
        permAddress: "1-123, Main Road, Peddakaparthy",
        caste: "BC-B",
        maritalStatus: "Married",
        spouse: "Lakshmi",
        income: "1-3 Lakhs",
        rationCard: "WAP1234567890 (White)",
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <DetailRow label="Caste / Community" value={member.caste} />
                                </div>
                            </div>
