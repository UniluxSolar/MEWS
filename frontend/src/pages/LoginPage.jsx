...
const LoginPage = () => {
    ...
    const handleForgotPassword = async (e) => {
        if (e) e.preventDefault();
        if (!username) {
            setFeedback({ type: 'error', text: 'Enter your Email or Mobile to receive a verification code' });
            return;
        }
        ...
        try {
            ...
            setFeedback({ type: 'error', text: error.response?.data?.message || 'Failed to send verification code' });
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            ...
            setFeedback({ type: 'error', text: error.response?.data?.message || 'Failed to update password' });
        } finally {
            setLoading(false);
        }
    };
